...
nsys profile -c cudaProfilerApi --output=$PROFILE_OUTPUT --gpu-metrics-devices="cuda-visible" srun uv run /home/horace/data/code/test_optim_gpu/toy-example-gpu/examplegpu/src/main.py
